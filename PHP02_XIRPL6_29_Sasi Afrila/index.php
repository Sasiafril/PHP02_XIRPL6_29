<?php 
    ...
    if(isset($_POST['b_simpan']))
    {
        ...
        if($_GET['hal'] == "edit")
        {
            ...
            id_siswa = '$_POST[tid]', 
            nis = '$_POST[tnis]', 
            nama_lengkap = '$_POST[tnama_lengkap]', 
            ...
            $simpan = mysqli_query($koneksi, "INSERT INTO buku (id_siswa, nis, nama_siswa, jenis_kelamin, alamat, id_jurusan)
...
<body>
    <div class="container">
        <h3 class="text-center">Praktek CUD PHP & MySQL </h3>
        <h4 class="text-center">Sasi Afrila Putri P</h4>
             ...
             <form method= "GET" action="">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php
                        ...
                        $no = 1;
                        $tampil = mysqli_query($koneksi, "SELECT * FROM buku order by id_siswa asc");
                        if (isset($_GET['cari'])) {
                            $tampil = mysqli_query($koneksi, "SELECT * FROM buku WHERE nama_siswa LIKE '%".
                                $_GET['cari']."%'");
                        }
